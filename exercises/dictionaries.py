...
cities = {"CA": "San Fransisco", "MI": "Detroit", "FL": "Jackonville"}
...
# Map city abbreviations and their football teams
football_teams = {
...
# print out some cities
print("-" * 20)
print("Manchester abbreviation is: ", england_cities["Manchester"])
print("Liverpool abbreviation is: ", england_cities["Liverpool"])


# print out every city abbreviations
print("-" * 30)
for city, abbrev in list(england_cities.items()):
    print(f"{city} is abbreviated: {abbrev}")

# print out football teams city abbreviations
print("-" * 40)
